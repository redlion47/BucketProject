...
class AuthTestCase(unittest.TestCase):
	...
	def test_registration(self):
		...
		# assert that that the request contains a success message and a 201 status code
	...
	def test_user_login(self):
		...
		# Test that the esponse contains success message
	...
	def test_non_registered_user_login(self):
		...
		# Define a dictionary to represented an unregestered user
		not_a_user = {
		...
		# Assert that this response mmust contain an error message
